...
@section('content')
    <div id="home" class="parallax first-section wow fadeIn" data-stellar-background-ratio="0.4"
        style="background-image:url('images/slider-bg.png');" {{ $app = App\Models\settings::latest()->first() }}>
        <div class="container">
            <div class="row">
                    ...
                    <div class="text-contant">
                        <h2>
                            <span class="center"><span class="icon"><img
                                        src="{{ $app ? config('app.url') . 'storage/' . $app->icon_logo_path : 'images/icon-logo.png' }}"
                                        alt="#" /></span></span>
                ...
                <div class="row">
                    <div class="service-time middle" style="background:#0071d1;">
                        ...
                        <div class="time-table-section">
                            <ul>
                                <li><span class="left">Monday - Friday</span><span class="right">8.00 – 12.00</span></li>
                                <li><span class="left">Saturday</span><span class="right">8.00 – 12.00</span></li>
                                <li><span class="left">Sunday</span><span class="right">8.00 – 12.00</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div id="about" class="section wow fadeIn">
        <div class="container">
            <div class="heading">
                <span class="icon-logo"><img src="{{ $app ? 'storage/' . $app->icon_logo_path : 'images/icon-logo.png' }}"
                        alt="#"></span>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="service-widget">
                        <div class="post-media wow fadeIn">
                            <a href="images/clinic_01.jpg" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="service-widget">
                        <div class="post-media wow fadeIn">
                            <a href="images/clinic_02.jpg" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i
                                    class="flaticon-unlink"></i></a>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="service-widget">
                        <div class="post-media wow fadeIn">
                            <a href="images/clinic_03.jpg" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i
                                    class="flaticon-unlink"></i></a>
